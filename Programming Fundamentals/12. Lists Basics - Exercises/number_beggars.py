...
the second one collects [2, 4]. The same list with 3 beggars would produce a better outcome for the
second beggar: 5, 7 and 3, as they will respectively take [1, 4], [2, 5], and [3].
...
while start_index < beggars_count:
    ...
    for current_index in range(start_index, len(money_as_integers), beggars_count):
