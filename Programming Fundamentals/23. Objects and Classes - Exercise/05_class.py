...
Each class should also have 2 empty lists - students and grades. Create a class attribute __students_count equal to 22.
...
class Class:
	...
	def get_average_grade(self):
		# grades_to_sum = [float(grade) for grade in self.grades] - there is no need to do this list comprehension
