...
the console, separated by a comma and a space ", ". The input will be a string containing phone numbers and other symbols.
...
not a combination of both (e.g., +359 2-111 111 has mixed delimiters, it is invalid).
