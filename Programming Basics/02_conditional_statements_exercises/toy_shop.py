...
count_ordered_toys = puzzle + dolly + bear + minion + truck
total_sum = puzzle * 2.6 + dolly * 3 + bear * 4.1 + minion * 8.2 + truck * 2

if count_ordered_toys >= 50:
    total_sum *= 0.75

rent = total_sum * 0.1
difference = abs(total_sum - rent - budget)

if total_sum >= budget + rent:
