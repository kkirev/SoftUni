...
for jury in range(jury_count):
    ...
    jury_points_final = (len(jury_name) * jury_points) / 2
    total_points += jury_points_final
    final_score = total_points + academy_points
    diff = 1250.5 - total_points - academy_points
