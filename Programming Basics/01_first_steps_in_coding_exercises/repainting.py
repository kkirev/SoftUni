...
total_materials = (nylon_needed + 2) * 1.5 + (paint_needed + paint_needed * 0.1) * 14.5 + thinner_needed + 0.4
work_payment = total_materials * 0.3 * hours_needed

print(total_materials + work_payment)